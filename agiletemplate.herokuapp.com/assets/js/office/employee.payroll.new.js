...
// location / employee change
  ...
  $('.select-store').on('change', () => {
    if($('.select-employee').val() != "") {
      // $('#payroll-table thead th').css("padding", "0.5rem");
      // $('#payroll-table tbody td').css("padding", "0.5rem");
      // $('#reason-pay-table thead th').css("padding", "0.5rem");
      // $('#reason-pay-table tbody td').css("padding", "0.5rem");
