(function ($, theme) {
  ...
  var init = function(){
    ...
    $('#top-categories').chartjs(
      {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Charcuterie ',
                    data: [2700, 3000, 3100, 3400, 3200, 3500, 3600, 3700, 3600, 3900, 4000, 4100],
                    fill: true,
                ...
                {
                    label: 'Beverages ',
                    data: [3000, 3300, 3400, 3600, 4300, 4800, 5100, 5200, 5500, 5400, 5600, 5800],
                    fill: true,
                    backgroundColor: hexToRGB(theme.color.primary, 0.0),
                    hoverBackgroundColor: theme.color.info,
                    pointRadius: 5,
                    tension: 0,
                    borderColor: theme.color.success,
                    pointBorderColor: '#fff',
                    pointBackgroundColor: theme.color.success,
                    borderWidth: 2
                }
                ,
                {
                    label: 'Bakery ',
                    data: [5500, 4800, 5200, 5000, 4500, 4300, 4000, 4200, 3800, 3500, 3600, 3800],
                    fill: true,
                    backgroundColor: hexToRGB(theme.color.primary, 0.0),
                    hoverBackgroundColor: theme.color.primary,
                    pointRadius: 5,
                    ...
                    pointBorderColor: '#fff',
                    pointBackgroundColor: theme.color.warning,
                    borderWidth: 3
                }
            ]
        },
    ...
    var ctx = document.getElementById('chart-total-sale').getContext("2d");
    var gradientStroke = ctx.createLinearGradient(0, 140, 0, 0);
    gradientStroke.addColorStop(0, "#FFFFFF");
    gradientStroke.addColorStop(1, "#F8DBA9");
    $('#chart-total-sale').chartjs(
      {
        type: 'line',
        data: {
            ...
            datasets: [
                {
                    label: 'L£ ',
                    data: [32000, 50200, 40500, 49000, 45000, 40000, 51000],
                    fill: true,
    ...
    function float2dollar(value){
      return "L£ "+(value).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    }
    let segment;
    $('#chart-most-profitable').chartjs(
    {
        type: 'doughnut',
        data: {
          labels: ['Short Bread Small', 'Apple Pie', 'Submarine Sandwich', 'Pineapple Pizza', 'Strawberry Soft Bread'],
            datasets: [
              {
                  label: '%',
                  data: [15, 20, 40, 10, 15],
        ...
        options: {
          ...
          onHover: function (evt, elements) {
            if (elements && elements.length) {
              segment = elements[0];
              this.chart.update();
              change_Segment(segment["_index"]);
              segment._model.outerRadius += 10;
              segment._model.borderColor = '#FFF';
            } else {
              if (segment) {
                segment._model.outerRadius -= 10;
                segment._model.borderColor = '#FFF';
    ...
    $('#chart-least-profitable').chartjs(
      {
          type: 'doughnut',
          data: {
            labels: ['Short Bread Small', 'Apple Pie', 'Submarine Sandwich', 'Pineapple Pizza', 'Strawberry Soft Bread'],
