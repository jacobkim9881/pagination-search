	  ...
	  _createClass(BootstrapTable, [{
		...
		if (this.options.cardView) {
          	if(Utils.getFieldTitle(_this7.columns, this.header.fields.length - 1) == "") {
				if((item._Category_class && item._Category_class.indexOf("subrow-dark") >= 0) || (item._Product_class && item._Product_class.indexOf("subrow-dark") >= 0))
					html.push("<td style=\"border-bottom: solid 1px #00000008 !important; border-top: none; background-color: #00000006\" colspan=\"".concat(this.header.fields.length, "\">"));
				else
