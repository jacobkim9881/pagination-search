...
$(document).ready(function() {
    ...
    $('#status-modal .confirm').click(function() {
        if(active_status == "enable") {
            ...
            notification("Automatic discount disabled");
        }
        else {
            ...
            notification("Automatic discount enabled");
        }
    });
    $('#delete-modal .confirm').click(function() {
        $('footer .save').attr("disabled", true);
        notification($('#discount-name').val() + " automatic discount deleted successfully.");
        $('#ghost .all-link')[0].click();
    });
    $('footer .save').click(function() {
        $(this).attr("disabled", true);
        notification($('#discount-name').val() + " automatic discount updated successfully.");
        $('#ghost .all-link')[0].click();
    });
